...
This script prompts the user for a task, its priority, and whether it is time-bound,
then provides a customized reminder using match-case and conditional statements.
"""
